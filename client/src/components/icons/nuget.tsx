...
export const nuGetBrandColour = "#004880"

export const nuGetIconColours = {
  brand: nuGetBrandColour,
  inherit: "currentColor",
} as const

export type NuGetIconProps = IconProps & {
  variant?: keyof typeof nuGetIconColours | null | undefined
}

// https://simpleicons.org/?q=nuget
export function NuGetIcon({ variant, ...props }: NuGetIconProps) {
  const fillColour = nuGetIconColours[variant ?? "inherit"]
  return (
